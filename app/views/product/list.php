...
<ul class="list-group">
    <?php foreach ($products as $product): ?>
        <li class="list-group-item">
            ...
            <p class="doanhmuc_p">Danh mục: <?php echo htmlspecialchars($product->category_name, ENT_QUOTES, 'UTF-8'); ?></p>
            <div class="row">
    ...
    <img src="/webbanhang/public/img/add-removebg-preview.png" alt="Thêm sản phẩm">
</a>
            </div>
        </li>
    <?php endforeach; ?>
